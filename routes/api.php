...
Route::controller(BookDonationController::class)->prefix('user/bookDonations')->group(function (){
    ...
    Route::get('getUndeliveredDonationsForUser','getUndeliveredDonationsForUser')->name('getUndeliveredDonationsForUser');
    Route::get('getDeliveredDonationsForUser','getDeliveredDonationsForUser')->name('getDeliveredDonationsForUser');
    Route::get('getWaitedReservationsToReceive','getWaitedReservationsToReceive')->name('getWaitedReservationsToReceive');
    Route::get('getDeliveredReservations','getDeliveredReservations')->name('getDeliveredReservations');
    Route::get('getWaitedReservationsToCollect','getWaitedReservationsToCollect')->name('getWaitedReservationsToCollect');
    Route::get('getFailedReservations','getFailedReservations')->name('getFailedReservations');
    Route::get('getRejectedDonationsForUser','getRejectedDonationsForUser')->name('getRejectedDonationsForUser');
    //Route::get('getBeneficiary/{id}','getBeneficiary')->name('BookDonation.getBeneficiary');
    Route::put('cancelReservationInPointByBeneficiary/{bookDonation_id}','cancelReservationInPointByBeneficiary')->name('cancelReservationInPointByBeneficiary');
    Route::put('cancelReservationNotInPointByBeneficiary/{bookDonation_id}','cancelReservationNotInPointByBeneficiary')->name('cancelReservationNotInPointByBeneficiary');
});
//                                                  *  Image Controller  *
